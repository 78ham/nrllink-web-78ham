export default {
  ...
  bm: {
    title: 'BM Network Management',
    subtitle: 'NRL-BM BrandMeister Interconnection & Bridge Configuration',
    addConfig: 'New BM Network',
    editConfig: 'Edit BM Network',
    ...
    callsign: 'Callsign',
    dmrid: 'DMR-ID',
    defaultTG: 'Default Talkgroup (TG)',
    ...
    selectDevice: 'Select NRL-BM Device',
    selectNetwork: 'Select BM Network'
  }
}
